...
function webtinus_theme_setup() {
	...
	add_image_size( 'imgBlog', 280, 200, true );
...
add_action( 'wp_enqueue_scripts', 'webtinus_name_styles' ); 
function webtinus_name_styles() { 
	...
	<li <?php comment_class(); ?>>
		<div id="comment-<?php comment_ID(); ?>" class="comment-box">
            <div class="comment-left" itemscope itemtype="http://schema.org/Person">
				...
				<?php endif; ?>
				<h5 itemprop="name"><?php comment_author(); ?></h5><span><?php echo get_comment_time(); ?></span>
